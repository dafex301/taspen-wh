...
@section('container')
        ...
        <div class="card">
            <div class="card-body">
                <div class="mb-3 d-flex justify-content-between">
                    ...
                    <button onclick="window.print()" class="btn btn-primary" style="height: 40px;">Cetak Dokumen</button>
                </div>
    ...
    <div class="print">
        ...
        <center>
            ...
            <p>No: RSM-{{ str_pad($realisasiPengadaanNewId, 3, '0', STR_PAD_LEFT) }}/CU.04/{{ date('mY') }}</p>
        </center>
